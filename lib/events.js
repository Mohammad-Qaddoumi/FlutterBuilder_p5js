function setEvents()
{
    ...
    showBars.addEventListener('click', e => {
        if(selected instanceof Grid && selected.Id !== screensArray[selectedScreen].Id)
...
function changeTheSelectedProperty() {
    ...
    //     return;
    // }
    s.innerText = `SelectedItem: ${selected.name}`;
    if(selected.Id === screensArray[selectedScreen].Id)
